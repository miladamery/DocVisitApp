...
(function () {
    ...
    DayPilotCalendar.Calendar = function (id, options) {
        ...
        this._getCallBackHeader = function () {
            ...
            h.showTimePostfix = calendar.showTimePostfix;
        ...
        this._resolved.showTimePostfix = function () {

            if (calendar.showTimePostfix !== undefined) {
                return calendar.showTimePostfix;
            }
            return this.locale().showTimePostfix;
        };
        ...
        this._updateView = function (result, context) {
            ...
            if (result.UpdateType === "Full") {
                ...
                calendar.showTimePostfix = result.showTimePostfix ? result.showTimePostfix : calendar.showTimePostfix;
        ...
        this._prefixCssClass = function (part) {
            ...
            let prefix = this.theme || this.cssClassPrefix;
            if (prefix) {
                return prefix + part;
            } else {
                return "";
        ...
        this._createHourTable = function () {
            ...
            let hours = calendar._durationHours();
        ...
        this._createHourRow = function (table, i) {
            ...
            let start = this.startDate.addHours(i).addHours(calendar._visibleStart());
            let hour = start.getHours();

            let am = hour < 12;
            let timeFormat = resolved.timeFormat();
            let showTimePostfix = resolved.showTimePostfix();
        ...
        this._drawHeaderRow = function (create) {
            ...
            function drawHeaderCell(i) {
                ...
                let div = (create) ? document.createElement("div") : cell.firstChild;
                let inner;
                ...
                if (typeof calendar.onBeforeHeaderRender === 'function') {
                    ...
                    DayPilot.Util.copyProps(args.header, data, ['html', 'backColor','name', 'toolTip', 'areas', 'cssClass', 'verticalAlignment']);
                }
        ...
        this._loadEvents = function () {
            ...
            for (let i = 0; i < this._columns.length; i++) {
                ...
                let colStart = new DayPilot.Date(col.start);
                let colStartTicks = colStart.getTime();
                let colEnd = colStart.addTime(duration);
                let colEndTicks = colEnd.getTime();
