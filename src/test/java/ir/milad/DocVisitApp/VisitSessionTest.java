...
class VisitSessionTest {
    ...
    public void test1() {
        ...
        vs.giveAppointment(new Patient("09300000000", "Milad", "Amery", "2023-08-05"), nineOClock);
        vs.giveAppointment(new Patient("09300000000", "Milad", "Amery", "2023-08-06"), nine1_OClock);
    ...
    public void test2() {
        ...
        var t1 = vs.giveAppointment(p1, nine1_OClock);
        var t2 = vs.giveAppointment(p2, nine1_OClock);

        var t3 = vs.giveAppointment(p1, LocalTime.of(9,2, 0));
        var t4 = vs.giveAppointment(p2, LocalTime.of(9,4, 0));
        assertEquals(t1, t3);
        assertEquals(t2, t4);
    }
    ...
    public void test4() {
        ...
        var p1 = new Patient("09300000000", "Milad", "Amery", "2023-08-05");
        var p2 = new Patient("09300000000", "Milad", "Amery", "2023-08-05");
        vs.giveAppointment(p1, LocalTime.of(9, 5, 0));
        assertThrows(ApplicationException.class
                , () -> vs.giveAppointment(p2, LocalTime.of(9, 5, 0).plusMinutes(5))
        );
    }
